/**
 * @file Gestisce la registrazione di nuovi utenti (clienti e gestori),
 * l'invio di Magic Link per la verifica dell'email e la validazione dei campi del form.
...
/** @type {HTMLFormElement} registrationForm - Il modulo di registrazione. */
const registrationForm = document.getElementById("registrationForm");

// ✅ Se utente autenticato da magic link: mostra popup decisione
document.addEventListener("DOMContentLoaded", async () => {
    /**
     * Recupera la sessione utente da Supabase.
     * @type {object}
     */
    ...
    /** @type {HTMLSelectElement} roleSelect - L'elemento select per la scelta del ruolo. */
    const roleSelect = document.getElementById("role");
    /** @type {HTMLButtonElement} submitBtn - Il pulsante di invio del form. */
    const submitBtn = document.getElementById("submitBtn");

    /**
     * Array di campi obbligatori per il gestore.
     * @type {Array<Object>}
     */
    ...
    /**
     * Aggiorna lo stato dei campi obbligatori per i gestori.
     * I campi 'nome', 'cognome' e 'piva' diventano obbligatori se il ruolo selezionato è 'gestore'.
     */
...
/**
 * Salva i dati del nuovo utente nel database e avvia il processo di autenticazione con Magic Link.
 * @async
 * @param {Object} user - L'oggetto contenente i dati dell'utente da registrare.
 */
...
/**
 * Mostra un popup per avvisare l'utente che è stata inviata un'email di verifica.
 */
...
/**
 * Nasconde il popup di verifica email.
 */
